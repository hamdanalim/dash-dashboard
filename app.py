...
avocado = pd.read_csv("data/alpukat_fix.csv", sep=";", index_col=0)
            ...
            children=[
                dcc.Tabs(
                    ...
                    children=[
                        ...
                        dcc.Tab(
                            label="Make your own analysis",
                            children=[html.H3("Make your own analysis")],
                        ),
                    ],
                ),
...
def update_charts(City, avocado_type, start_date, end_date):
    ...
    volume_chart_figure = px.scatter(
        ...
        marginal_y="violin",
        labels={"SalesVolume": "Volume Penjualan", "AveragePrice": "Harga Rata - Rata"},
    )
